...
2. Open DMG and drag Klasiko to Applications folder
...
⚠️ **Step 3 is required** - macOS blocks unsigned apps downloaded from the internet.

📖 **Troubleshooting**: See [MACOS-INSTALL.md](MACOS-INSTALL.md) for detailed help
